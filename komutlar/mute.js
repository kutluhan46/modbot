...
const ms = require("ms");
var mutelu = "778011580508012574"; //buraya muteli rolünün id'sini koyunuz
var muteyetkisi = "778011596588449802"; // buraya mute yetkis irolünün id yazınız.
      ...
      if (
        ...
        if (!mutezaman) {
          ...
          let log = msg.guild.channels.find(c =>
            c.name.toLowerCase().includes("mute-info")
          );
          let vakit = mutezaman
            .replace("m", " dakika")
            .replace("s", " saniye")
